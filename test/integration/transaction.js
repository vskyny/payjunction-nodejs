...
describe('transactions', function(){
  ...
  describe('void a transaction', function(){
    ...
    before(function(done){
      ...
      createTransaction(function(data){
        var transaction = payjunction.transaction.update(data.transactionId, {
          status: 'VOID'
        });
  ...
  describe('add a signature', function(){
    ...
    before(function(done){
      ...
      createTransaction(function(data){
        var request = payjunction.transaction.addSignature(data.transactionId, {
  ...
  describe('read a transaction', function(){
    ...
    before(function(done){
      ...
      createTransaction(function(data){
        ...
        var request = payjunction.transaction.read(data.transactionId);
